...
function SpmSender (spmToken, processMetricsInterval, metricsApiEndpoint) {
  ...
  this.tid = null
  this.metricsUrl = (metricsApiEndpoint || config.get('spmSenderBulkInsertUrl') || defaultSpmSenderUrl) + '?agentType=nodejs&v=' + clientVersion + '&host=' + hostname + '&token=' + spmToken
...
SpmSender.prototype.startSender = function () {
  ...
  }, Math.max(5000, config.transmitInterval))
  tid.unref()
}
/**

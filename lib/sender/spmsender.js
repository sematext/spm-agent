...
SpmSender.prototype.sendClientInfo = function () {
  ...
  var info = (process.env.SPM_REPORTED_HOSTNAME || os.hostname()) + ': ' + os.platform() + ', ' + os.arch() + ', ' + runtime + ' ' + process.versions.node + ', ' + 'spm ' + programVersion

  var serverInfo = {
    message: info,
    tags: info.split(','),
    priority: 0,
    name: packageName + ' ' + programVersion,

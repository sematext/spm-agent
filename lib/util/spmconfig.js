...
var spmDefaultConfig = {
  ...
  collectionInterval: Number(process.env.SPM_COLLECTION_INTERVAL_IN_MS) || 20000,
  transmitInterval: Number(process.env.SPM_TRANSMIT_INTERVAL_IN_MS) || 10000,
  ...
  logger: {
    ...
    useLogstashFormat: process.env.SPM_LOG_LOGSTASH_FORAMT || false,
